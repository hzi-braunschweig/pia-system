...
This file has been modified:
 - added PIA logo and favicon
 - added realm name css class to body tag
-->
...
<body class="${properties.kcBodyClass!} realm-id_${realm.name}">
<div class="${properties.kcLoginClass!}">
    <div class="${properties.kcFormCardClass!}">
        ...
        <#if !(auth?has_content && auth.showUsername() && !auth.showResetCredentials())>
            <img id="pia-logo" src="${url.resourcesPath}/img/pia_logo.png" alt="PIA Logo" />
