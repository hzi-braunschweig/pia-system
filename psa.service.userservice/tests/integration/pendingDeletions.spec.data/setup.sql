...
VALUES ('qtest-api-proband1', TRUE, TRUE, TRUE, 'ApiTestStudie1', 'investigator'),
       ('qtest-api-proband2', TRUE, TRUE, TRUE, 'ApiTestStudie1', 'investigator'),
       ('qtest-api-proband3', TRUE, TRUE, TRUE, 'ApiTestStudie3', 'investigator'),
       ('qtest-api-proband4', TRUE, TRUE, TRUE, 'ApiTestStudie1', 'investigator');
