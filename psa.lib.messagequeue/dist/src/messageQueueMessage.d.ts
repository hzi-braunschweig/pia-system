...
export declare type MessageQueueMessage = ProbandCreatedMessage | ProbandDeletedMessage | ProbandDeactivatedMessage | ProbandEmailVerifiedMessage | ProbandLoggedInMessage | ProbandRegisteredMessage | ComplianceCreatedMessage | StudyDeletedMessage | QuestionnaireInstanceCreatedMessage | QuestionnaireInstanceActivatedMessage | QuestionnaireInstanceExpiredMessage | QuestionnaireInstanceAnsweringStartedMessage | QuestionnaireInstanceReleasedMessage | FeedbackStatisticConfigurationUpdatedMessage;
