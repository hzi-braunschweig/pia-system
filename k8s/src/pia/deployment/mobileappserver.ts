...
export class MobileappServer extends Chart {
  public readonly service: Service;

  public constructor(scope: Construct, configuration: Configuration) {
    const serviceName = 'mobileappserver';
    ...
    const deployment = new DeploymentWithoutServiceLinks(this, 'deployment', {
      ...
      metadata: { ...configuration.getMetadata(), name: 'mobileappserver' },
      ...
      containers: [
        {
          image: configuration.getImage('psa.app.mobile'),
