...
To use HMR (Hot module replacement) in development, run the following command inside this directory:
...
open the admin-console in your browser (http://localhost:8080/, username and password being `admin`), when you the go to the `Manage Account` by clicking on the name in the toolbar, you will see the custom UI.
