...
const models: TsoaRoute.Models = {
    "Pick_EventEntity.Exclude_keyofEventEntity.type__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"payload":{"dataType":"union","subSchemas":[{"dataType":"nestedObjectLiteral","nestedProperties":{"pseudonym":{"dataType":"string","required":true}}},{"dataType":"nestedObjectLiteral","nestedProperties":{"pseudonym":{"dataType":"string","required":true}}},{"dataType":"nestedObjectLiteral","nestedProperties":{"pseudonym":{"dataType":"string","required":true}}},{"dataType":"nestedObjectLiteral","nestedProperties":{"pseudonym":{"dataType":"string","required":true}}},{"dataType":"nestedObjectLiteral","nestedProperties":{"pseudonym":{"dataType":"string","required":true}}},{"dataType":"nestedObjectLiteral","nestedProperties":{"pseudonym":{"dataType":"string","required":true}}},{"dataType":"nestedObjectLiteral","nestedProperties":{"releaseVersion":{"dataType":"double","required":true},"id":{"dataType":"double","required":true}}}],"required":true},"id":{"dataType":"double","required":true},"studyName":{"dataType":"string","required":true},"timestamp":{"dataType":"datetime","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Omit_EventEntity.type_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_EventEntity.Exclude_keyofEventEntity.type__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "EventTypeString": {
        "dataType": "refAlias",
        "type": {"dataType":"enum","enums":["proband.created","proband.deleted","proband.deactivated","proband.logged_in","proband.email_verified","compliance.created","questionnaire_instance.released"],"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "EventResponseDto": {
        "dataType": "refAlias",
        "type": {"dataType":"intersection","subSchemas":[{"ref":"Omit_EventEntity.type_"},{"dataType":"nestedObjectLiteral","nestedProperties":{"type":{"ref":"EventTypeString","required":true}}}],"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
